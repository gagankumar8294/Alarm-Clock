...
let audioSound = new Audio(" ./public/music/audio.wav ");
let audioDelete = new Audio('./public/music/delete.mp3');
let audioSet = new Audio('./public/music/set.mp3');
let audioAlert = new Audio('./public/music/alert.mp3');
let audioPlay = false;
